...
public class Parabens implements Screen{
    private Viewport viewport;
    private Stage stage;

    private VikingWorld game;

    public Parabens(VikingWorld game){
        this.game = game;
        ...
        Label gameOverLabel = new Label("PARABENS FASE CONCLUIDA!!!!", font);
        Label playAgainLabel = new Label("Clique para jogar novamente", font);
